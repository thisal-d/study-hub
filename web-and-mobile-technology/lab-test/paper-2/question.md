...
## Student Manager MERN Application Enhancement and Deployment

---

## 1. Lab Test Overview

You are provided with a starter MERN **Student Manager** project containing separate frontend and backend applications. Your task is to complete the given project, extend it by adding a new field called **GPA** (Grade Point Average), test it locally using your own MongoDB connection string, publish the source code to a public GitHub repository, and deploy the frontend and backend separately using free hosting platforms.
...
- Updating both frontend and backend to support a new numeric data field with validation.
...
- Frontend project of the Student Manager application (React + Vite).
- Backend project of the Student Manager application (Node.js + Express + MongoDB).
- Basic CRUD functionality already included in the starter project (Add / View / Edit / Delete students).
...
- Verify the following:
  ...
  - You can navigate between pages (Home, Add Student).
  - Existing features (Add Student / View Students / Edit Student / Delete Student) are working.
...
Modify the application by adding a new field named **GPA** to the Add Student form.
...
- Ensure that the **GPA** value is shown on the Home page together with the other student details (Full Name, Faculty, Year, Email).
...
**Field Specification:**
- Field name: `gpa`
- Type: Number (decimal accepted)
- Validation: Required · Minimum value: `0.0` · Maximum value: `4.0`
- Example value: `3.75`
- Display hint: Show the GPA on the student card with two decimal places (e.g., **GPA: 3.75 / 4.00**)
...
4. Verify that the live system works successfully after deployment (add a student and confirm it appears on the home page with the GPA).
...
- Screenshot of the locally running **existing** project — Add Student page
- Screenshot of the locally running **existing** project — Home page
- Screenshot of the locally running **updated** project — Add Student page *(showing the GPA field)*
- Screenshot of the locally running **updated** project — Home page *(showing GPA displayed on the student card)*
- Frontend Live URL
- Backend Live URL
...
| New field integration (GPA) | Adds the GPA field to the form and updates frontend and backend correctly. | 20 | Validation (0.0–4.0) must be enforced. |
| Home page display | GPA is shown properly on the Home page alongside other student details. | 10 | Visible evidence must match the implementation. |
