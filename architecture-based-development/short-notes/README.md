...
## 💡 Note Highlights
* **Point-wise & Categorized:** Easy to read and review.
* **Dual-Language Terms:** Key technical terms include clear Sinhala translations in brackets `(සිංහල අර්ථය)`.
* **Real-World Scenarios:** Every major concept is illustrated with concrete industry examples.
* **Quick Revision Tables:** Every note concludes with a condensed comparison/summary table for rapid exam prep.
