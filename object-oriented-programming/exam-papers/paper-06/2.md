...
In the car rental agency, a customer can reserve and return vehicles. The rental agent manages the fleet of cars and processes rental agreements. Customers can search for available cars by type or location. Each vehicle has a unique registration number and a rental rate that determines the daily cost. The system tracks vehicle maintenance schedules and generates invoices for completed rentals.
