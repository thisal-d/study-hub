...
d. Consider the system which processes financial transactions for a bank network with 12 ATM branches and thousands of customers. At each branch, ATMs process withdrawals by reading and updating the shared account balance. Each transaction will be stored in a shared file named TransactionLog.

<div style='text-align: center;'><img src="./assets/paper-5/q1.png"/></div>

i. Find the critical section of the above ATM transaction system.
...
b. Consider the following contiguous memory allocation system with the free memory segments of A, B, C, D with the size of 350KB, 150KB, 500KB and 100KB respectively.
...
c. A computer system has 256MB physical memory and 2GB virtual memory, if the operating system uses 32KB page in paging system.
...
<div style='text-align: center;'><img src="./assets/paper-5/q2.png"/></div>

## Question 3

a. List the four necessary conditions to have a deadlock in a system.

b. Propose two solutions to prevent the deadlock by deny the no pre-emption condition.
...
<div style='text-align: center;'><img src="./assets/paper-5/q3.png"/></div>

e. Consider the following snapshot of a system:

<table border="1"><tr><td>Process</td><td>Allocation</td><td>Maximum Needs</td><td>Available</td></tr><tr><td>X</td><td>2</td><td>5</td><td>1</td></tr><tr><td>Y</td><td>1</td><td>4</td><td></td></tr><tr><td>Z</td><td>3</td><td>6</td><td></td></tr><tr><td>W</td><td>4</td><td>7</td><td></td></tr></table>
...
iii. If a request from process Z arrives for 2 resources, can the request be granted immediately?
...
e. Consider the following page reference string: 1, 2, 5, 6, 2, 1, 3, 6, 2, 1, 2, 3, 7, 6
